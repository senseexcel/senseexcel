...
• You must have acccess to either Qlik Sense Desktop or Qlik Sense Server software.

• Confirm that you have a .NET Framework >= 4.5.1 installed, otherwise download it from www.microsoft.com and install it. 
...
### 4.2  Qlik Sense Server Configuration - NOT REQUIRED FOR USE WITH ONLY QLIK SENSE DESKTOP

If you are only using Sense Excel with Qlik Sense Desktop skip directly to Chapter 5. You DO NOT need to perform the steps in Chapter 4.2.
...
Version 4.0 includes a new Install-Updater program. If you need to access older Sense Excel versions and installation workflows, see Appendix 1 at the end of this document.

### 5.1 Download Software

You can acquire the Sense Excel Install-Updater program from the link below:

https://m.sense2go.net/asset/63:sense-excel-install--updater.  Clicking or pasting the link in a browser will download to your Downloads folder.  

BEST PRACTICE:  Move the SE-Install-Updater.exe file from your Downloads folder to a new folder in your Documents or Desktop called Sense Excel.  
...
![SER Installer Close Windows](https://github.com/senseexcel/senseexcel/blob/master/docs/SE-Installer-Close-Windows.png)

![SER Installer Normal Mode](https://github.com/senseexcel/senseexcel/blob/master/docs/SE-Installer-Normal-Mode.png)

![SER Installer Updating](https://github.com/senseexcel/senseexcel/blob/master/docs/SE-Installer-Updating.png)

![SER Installer Expert Mode](https://github.com/senseexcel/senseexcel/blob/master/docs/SE-Installer-Expert-Mode.png)

![SER Installer Expert Mode Old Versions](https://github.com/senseexcel/senseexcel/blob/master/docs/SE-Installer-Expert-Mode-Old-Versions.png)
